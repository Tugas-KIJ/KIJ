...
public class DES {
    ...
    */
    ...
    //Fungsi Subtitusi
    public static String subtitusi(String a){
        String g = "";
        ...
        for(int i=1;i<9;i++){
            ...
            //System.out.println(S[i-1][k][l]);
            System.out.println(Integer.toBinaryString(S[i-1][k][l]));
            if(S[i-1][k][l]<2)
            {
        ...
        //return Integer.toBinaryString(b[k][l]);
        return g;
    }
    ...
    //Fungsi Permutasi
    public static String permutation(String a, int[] b){
        String g="";
        for(int c: b){
            g += a.charAt(c-1);
        }
    ...
    public static String LeftShift(String a, int b){
        String g="";
        //int i =0;
        for(int i = 0 ; i <28 ; i++ ){
          //  System.out.println((i+b)%28 + " " + a.charAt((i+b)%28));
            g += a.charAt((i+b)%28);
        }
        return g;
    }
